...
/// @brief Aloca o matrice binara cu dimensiunile date daca. Nu uita BinMat_free_ptr pentru eliberare!
/// @param rows 
/// @param cols 
/// @return BinMatrix* sau NULL in caz de eroare la malloc
...
/// @brief Salveaza matricea binara in fisierul deschis cu fd. 
/// @param bm 
...
/// @brief Salveaza matricea binara in fisierul filename.
/// @param bm 
/// @param filename 
...
/// @brief Loads a BinMatrix from an open file descriptor
/// @param fd 
...
/// @brief Elibereaza memoria alocata pentru matricea binara
/// @param bm 
...
/// @brief Fill matrix with sequential values starting from 0
...
/// @brief Fill matrix with constant value v
...
/// @brief Fill matrix with random values in [min, max]
/// @param bm 
/// @param min 
/// @param max 
...
/// @brief Sets the diagonal elements to a specific value
/// @param bm 
/// @param value
...
/// @brief Returns a new matrix which is the sum of a and b
/// @param a 
/// @param b 
...
/// @brief Returns a new matrix which is the product of a and b
/// @param a 
/// @param b 
/// @return Returns NULL on error
